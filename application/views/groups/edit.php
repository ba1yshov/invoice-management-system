  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('groups/') ?>">Группы</a></li>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Обновление группы</h3>
            </div>
            <form role="form" action="<?php base_url('groups/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Введите название группыe" value="<?php echo $group_data['group_name']; ?>">
                </div>
                <div class="form-group">
                  <label for="permission">Права доступа</label>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('groups/') ?>" class="btn btn-warning">Назад</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
