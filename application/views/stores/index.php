...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    Управление
      <small>Филиалами магазина</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createStore', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Добавить филиал</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Управление филиалами</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Адрес филиала</label>
            <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Введите адрес филиала" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Адрес филиала</label>
            <input type="text" class="form-control" id="edit_store_name" name="edit_store_name" placeholder="Введите адрес филиала" autocomplete="off">
          </div>
          <div class="form-group">
