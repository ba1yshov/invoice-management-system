          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Просмотр изображения: </label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Введите название продукта" value="<?php echo $product_data['name']; ?>"  autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="sku">Артикул</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Введите артикул" value="<?php echo $product_data['sku']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" min="0" id="qty" name="qty" placeholder="Введите количество" value="<?php echo $product_data['qty']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  <label for="store">Наличие</label>
                  <select class="form-control" id="availability" name="availability">
                    <option value="1" <?php if($product_data['availability'] == 1) { echo "selected='selected'"; } ?>>Есть</option>
