          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Введите название продукта" autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="sku">Артикул</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Введите артикул" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" min="0" id="qty" name="qty" placeholder="Введите количество" value="1" autocomplete="off" />
                </div>
