    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createCategory', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Добавить категорию</button>
          <br /> <br />
        <?php endif; ?>
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Название категории</label>
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Введите название категории" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Название категории</label>
            <input type="text" class="form-control" id="edit_category_name" name="edit_category_name" placeholder="Введите название категории" autocomplete="off">
          </div>
          <div class="form-group">
