    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php //if(in_array('createGroup', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Добавить атрибут</button>
          <br /> <br />
        <?php //endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Управление атрибутами</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('attributes/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Название атрибута</label>
            <input type="text" class="form-control" id="attribute_name" name="attribute_name" placeholder="Введите название атрибута" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Название</label>
            <input type="text" class="form-control" id="edit_attribute_name" name="edit_attribute_name" placeholder="Введите название атрибута" autocomplete="off">
          </div>
          <div class="form-group">
