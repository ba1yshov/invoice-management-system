...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('auth'); ?>"><b>Вход в систему</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('auth/login') ?>" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" id="email" placeholder="Электронная почта" autocomplete="off">
